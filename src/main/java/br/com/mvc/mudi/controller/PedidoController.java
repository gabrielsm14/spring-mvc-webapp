...
public class PedidoController {
	...
	@PostMapping("novo")
	public String novo(@Valid RequisicaoNovoPedido requisicaoNovoPedido, BindingResult result) { // informações do forumulario veio para requisicao, e depois salvei os dados 
		if(result.hasErrors()) {
			return "pedido/formulario";
		}
